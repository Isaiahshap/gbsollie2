...
export default function LibrarianPage() {
  ...
  useEffect(() => {
    ...
    trackFunnelPageView('Librarian', 'Landing Page', 1);
    trackTrafficSource();
    trackMetaFunnelView('Librarian', 'Landing Page');
            ...
            <div className="container-custom relative z-10">
              ...
              >
                <h1 className="text-3xl md:text-5xl font-display font-bold text-white mb-4">
                  Faith-Based Fantasy That Belongs in Your Library
                </h1>
                <p className="text-lg md:text-xl mb-8 text-white/90">
                  You carefully curate stories that reflect your school&apos;s mission — books that are wholesome, beautifully written, and spiritually enriching.
                </p>
                <div className="bg-white/10 rounded-lg p-6 mb-8 backdrop-blur-sm">
                  <p className="font-medium text-lg mb-4">Cat Luker: The Swamp Witch Chronicles series, Book-1 The Dark Clock checks every box:</p>
                  <ul className="space-y-2 text-left max-w-md mx-auto">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="text-secondary flex-shrink-0" size={20} />
                      <span>Strong literary quality</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="text-secondary flex-shrink-0" size={20} />
                      <span>Biblical themes of redemption and courage</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle className="text-secondary flex-shrink-0" size={20} />
                      <span>Discussion-ready for classrooms or reading groups (with Bible Study Guide)</span>
                    </li>
                  </ul>
                  <p className="mt-4 italic">It&apos;s a book your students will love — and one you can confidently recommend to both teachers and parents.</p>
                </div>
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-md mx-auto">
                  ...
                  <a 
                    ...
                    onClick={() => {
                      trackAmazonClick('Cat Luker: The Dark Clock', 'Librarian Hero CTA');
                      trackMetaAmazonClick('Cat Luker: The Dark Clock', 'Librarian Hero CTA');
                    }}
              ...
              >
                <motion.div variants={fadeIn} className="order-2 md:order-1">
                  ...
                  <div className="prose text-primary-light">
                    <p className="mb-4"><span className="font-bold text-accent">Cat Luker:</span> The Swamp Witch Chronicles began as stories I told my grandkids during our daily school carpools and are now refined for educational environments that want more than surface-level content.</p>
                    <p className="mb-4">These tall-tales, filled with excitement and important lessons, have evolved into a Christian fantasy series that you can use to inspire and prepare young students for the road ahead.</p>
            ...
            <div className="container-custom">
              ...
              >
                <motion.div variants={fadeIn}>
                  ...
                  <p className="mb-4">
                    Transform the adventure into a full experience with our dramatized audiobook! With sound effects, music, and professional narration by Grammy-winning Monroe Jones, your students will be transported into a world of fantasy and faith.
                  </p>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="mt-6">
                      <p className="font-display text-lg text-primary font-bold">Why settle for one format when you can enjoy both? Get the printed book and audiobook together and enjoy Cat Luker in the way that works best for your students.</p>
                    </div>
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="text-center md:text-left">
                    ...
                    <button 
                      onClick={() => {
                        trackModalOpen('Free Preview', 'Librarian Page');
                        trackMetaModalOpen('Free Preview', 'Librarian Page');
                        setIsModalOpen(true);
                      }}
